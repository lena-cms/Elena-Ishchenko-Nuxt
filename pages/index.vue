    ...
    <div class="about-banner">
      <div class="about-container1">
        <p class="about-text">
          ...
          <br />
          <br />
          <span><span v-html="rawwhkm"></span></span>
          <span><span v-html="rawrlba"></span></span>
        </p>
      </div>
