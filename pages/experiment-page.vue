  ...
  <div class="experiment-page-container">
    <div class="experiment-page-sidebar">
      <nav class="experiment-page-nav">
        <svg viewBox="0 0 1024 1024" class="experiment-page-icon">
          <path
            d="M128 554.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 298.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 810.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"
          ></path>
        </svg>
        <span class="experiment-page-text">Dashboard</span>
        <span class="experiment-page-text1">Calendar</span>
        <span class="experiment-page-text2">Team</span>
        <span class="experiment-page-text3">Documents</span>
        <span>Reports</span>
      </nav>
      <div class="experiment-page-profile">
        ...
        <div class="experiment-page-container1">
          <span class="experiment-page-text5">John Doe</span>
          <span class="experiment-page-text6">View Profile</span>
        </div>
      </div>
    </div>
  </div>
