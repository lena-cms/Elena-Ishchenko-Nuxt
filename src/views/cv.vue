    ...
    <div class="cv-container1">
      ...
      >
        <span class="cv-text030">
          ...
          <br />
          <a
            href="https://urvakan.com/exchangeonline/"
            target="_blank"
            rel="noreferrer noopener"
            class="cv-link03"
          >
      ...
      <cv-grid cv_years="2020" rootClassName="cv-grid-root-class-name13">
        <span class="cv-text045">
          ...
          <span>—</span>
          <span class="cv-text047">Anapa region, Krasnodar krai, Russia</span>
          <br />
          <a
          ...
          <span class="cv-text052">, Russia</span>
          <br />
          <a
      ...
      <cv-grid cv_years="2019" rootClassName="cv-grid-root-class-name4">
        <span class="cv-text057">
          ...
          <span>/ Curator</span>
          <span class="cv-text059">Typography CCA, Krasnodar, Russia</span>
          <br />
          <a
          ...
          <span> </span>
          <span class="cv-text062">Various venues, Krasnodar, Russia</span>
          <br />
          <span>
      ...
      <cv-grid cv_years="2018" rootClassName="cv-grid-root-class-name14">
        <span class="cv-text067">
          ...
          <span>/ Curator </span>
          <span class="cv-text069">Typography CCA, Krasnodar, Russia</span>
          <br />
          <a
          ...
          <span class="cv-text075">Work Hard! Play Hard! — Minsk, Belarus</span>
          <br />
          <a
